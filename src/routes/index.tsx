      ...
      <div id="top" className="min-h-dvh overflow-x-hidden">
        ...
        <main>
          ...
          <section className="relative overflow-hidden bg-gradient-to-b from-sand via-background to-background">
            ...
            />
            <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pb-12 pt-2 sm:px-6 md:grid-cols-[0.95fr_1.05fr] md:pb-16 md:pt-4 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:pb-20 lg:pt-6">
