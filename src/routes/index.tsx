      ...
      <div id="top" className="min-h-dvh overflow-x-hidden pb-20">
        ...
        <main>
          ...
          <section className="relative mt-4 overflow-hidden sm:mt-6 bg-gradient-to-b from-sand via-background to-background">
            ...
            />
            <div className="relative mx-auto grid w-full max-w-6xl items-center gap-8 px-4 pb-28 pt-6 sm:px-6 sm:pb-36 md:grid-cols-[0.95fr_1.05fr] md:gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14">
