...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <article
      ...
      className="soft-card no-lift relative flex h-full scroll-mt-24 flex-col overflow-hidden"
    >
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <dl className="mt-4 grid grid-cols-3 gap-2">
          {product.highlights.map((h) => (
            ...
            >
              <dt className="font-display text-sm font-bold leading-none">
                {h.value}
              </dt>
          ...
          style={
            {
              ...
              "--fly-y": `${fly.y}px`,
              animation:
                "fly-to-cart 0.7s cubic-bezier(0.5,0,0.75,0) forwards",
