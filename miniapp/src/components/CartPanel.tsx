...
export function CartPanel() {
  ...
  useEffect(() => {
    ...
    if (count > 0 && !open) {
      ...
      return () => mb.offClick(handleClick);
    } else {
      mb.hide();
    }
  }, [tg, count, total, open, setOpen, haptic]);
  ...
  useEffect(() => {
    ...
    if (open) {
      ...
      return () => bb.offClick(handleClose);
    } else {
      bb.hide();
    }
  }, [tg, open, setOpen, haptic]);
  ...
  const checkout = () => {
    ...
    if (tg?.initData) {
      // In production, send tg.initData to your backend for validation
      console.log("Checkout with initData:", tg.initData);
    }
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <button
                        onClick={() => { haptic("light"); remove(product.id); }}
                    ...
                    <div className="mt-2 flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1 rounded-full bg-secondary p-1">
                        <button
                          onClick={() => { haptic("light"); dec(product.id); }}
                        ...
                        <button
                          onClick={() => { haptic("light"); inc(product.id); }}
